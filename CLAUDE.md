...
## 새 Claude 세션 진입 시 (필수 순서)

**1단계: [`사장님-룰.md`](사장님-룰.md) 먼저 읽기** — 사장님이 명시한 모든 운영 규칙. 절대 잊지 말 것. 안 읽고 작업 시작하면 시킨 거 또 잊고 사고 반복.

**2단계: `backup/` 폴더의 가장 최신 STATE 파일** — 최근 작업·사고·시스템 상태 파악.
