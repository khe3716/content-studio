...
function buildGyeoljaePrompt(date, allRounds, ctx) {
  ...
  return [
    ...
    '',
    '## 사용자 자산·비자산 (반드시 의식)',
    '진짜 자산: 1년차 1인 사장 시야·사고 패턴(다른 도메인에 일반화) / 한국어·비개발자 / 일반 사회 경험·관심사·취미',
    '**과일·신선식품 도메인 지식은 자산 아님 — 본업 영역**. 사용자는 "한국 1년차 1인 사업자, 비개발자"로만 취급.',
    '비자산: 팔로워 0 / 구독자 0 / 블로그 트래픽 미미 / 인플루언서 네트워크 없음 / 자본 0~10만원',
    '"기존 팬덤 활용" 같은 빈말 금지. 도달 부트스트랩(0→100명 3단계) 명시 안 된 후보는 ★ 이하 강등.',
    '',
    '## 🚫 자동 보류 (본업·인접 도메인 침범 — 후보 자격 없음)',
    '- 스마트스토어/쿠팡/네이버 셀러·온라인 판매자 대상 사업 일체',
    '- e커머스 셀러 노하우 상품화 (CS·정산·상세페이지·SEO 등)',
    '- **과일·신선식품·식자재·요리·식문화 주제 일체** (과일 선물·제철 캘린더·식재료·레시피·식품 안전 등 모두)',
    '- 농산물·산지·도매·식품 유통',
    '- 과일 블로그/SEO·마케팅 도구',
    '- "1년간 과일 운영 경험"을 신뢰성 근거로 쓰는 후보 (본업 우려먹기)',
